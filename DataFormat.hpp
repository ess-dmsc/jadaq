...
struct __attribute__((__packed__)) ListElement422 {
  ...
  static void insertMembers(H5::CompType &datatype) {
    datatype.insertMember("time", HOFFSET(ListElement422, time),
                          H5::PredType::NATIVE_UINT32);
    datatype.insertMember("channel", HOFFSET(ListElement422, channel),
                          H5::PredType::NATIVE_UINT16);
    datatype.insertMember("charge", HOFFSET(ListElement422, charge),
                          H5::PredType::NATIVE_UINT16);
  }
...
static_assert(std::is_pod<ListElement422>::value,
              "Data::ListElement422 must be POD");
...
struct __attribute__((__packed__)) ListElement8222 {
  ...
  static void insertMembers(H5::CompType &datatype) {
    datatype.insertMember("time", HOFFSET(ListElement8222, time),
                          H5::PredType::NATIVE_UINT64);
    datatype.insertMember("channel", HOFFSET(ListElement8222, channel),
                          H5::PredType::NATIVE_UINT16);
    datatype.insertMember("charge", HOFFSET(ListElement8222, charge),
                          H5::PredType::NATIVE_UINT16);
    datatype.insertMember("baseline", HOFFSET(ListElement8222, baseline),
                          H5::PredType::NATIVE_UINT16);
  }
...
static_assert(std::is_pod<ListElement8222>::value,
              "Data::ListElement8222 must be POD");
...
struct __attribute__((__packed__)) WaveformElement {
  ...
  static ElementType type() {
    return (ElementType)(WaveformBase | ListElementType::type());
  }
  ...
  static size_t size(size_t samples) {
    return ListElementType::size() + Waveform::size(samples);
  }
...
static_assert(std::is_pod<WaveformElement<Data::ListElement422>>::value,
              "Data::WaveformElement<Data::ListElement422> > must be POD");
...
static inline std::ostream &operator<<(std::ostream &os,
                                       const Data::ListElement422 &e) {
  e.printOn(os);
  return os;
}
static inline std::ostream &operator<<(std::ostream &os,
                                       const Data::ListElement8222 &e) {
  e.printOn(os);
  return os;
}
static inline std::ostream &
operator<<(std::ostream &os,
           const Data::WaveformElement<Data::ListElement422> &e) {
  e.printOn(os);
  return os;
}
static inline std::ostream &
operator<<(std::ostream &os,
           const Data::WaveformElement<Data::ListElement8222> &e) {
  e.printOn(os);
  return os;
}
