...
enum FunctionID {
    ...
    EasyGlobalTriggerMaskHelper,
    EasyDPPGlobalTriggerMaskHelper,
    FrontPanelTRGOUTEnableMask,
    EasyFrontPanelTRGOUTEnableMask,
    EasyDPPFrontPanelTRGOUTEnableMask,
    EasyFrontPanelTRGOUTEnableMaskHelper,
    EasyDPPFrontPanelTRGOUTEnableMaskHelper,
    FrontPanelIOControl,
    EasyFrontPanelIOControl,
    EasyDPPFrontPanelIOControl,
    EasyFrontPanelIOControlHelper,
    EasyDPPFrontPanelIOControlHelper,
    ROCFPGAFirmwareRevision,
    EasyROCFPGAFirmwareRevision,
    EasyDPPROCFPGAFirmwareRevision,
    EasyROCFPGAFirmwareRevisionHelper,
    EasyDPPROCFPGAFirmwareRevisionHelper,
    EventSize,
    FanSpeedControl,
    EasyFanSpeedControl,
    EasyDPPFanSpeedControl,
    EasyFanSpeedControlHelper,
    EasyDPPFanSpeedControlHelper,
    ...
    EasyAMCFirmwareRevisionHelper,
    EasyDPPAMCFirmwareRevisionHelper,
    ChannelSelfTrigger,
    GroupSelfTrigger,
