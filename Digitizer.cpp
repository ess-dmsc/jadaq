...
static void set_(caen::Digitizer* digitizer, FunctionID functionID, const std::string& value)
{
    switch(functionID)
    {
        ...
        SET_CASE(digitizer,EasyBoardConfigurationHelper,s2ebch(value))
        SET_CASE(digitizer,EasyDPPBoardConfigurationHelper,s2edbch(value))
        ...
        SET_CASE(digitizer,EasyAcquisitionControlHelper,s2each(value))
        SET_CASE(digitizer,EasyDPPAcquisitionControlHelper,s2edach(value))
        ...
        SET_CASE(digitizer,EasyGlobalTriggerMaskHelper,s2egtmh(value))
        SET_CASE(digitizer,EasyDPPGlobalTriggerMaskHelper,s2edgtmh(value))
        ...
        SET_CASE(digitizer,EasyFrontPanelTRGOUTEnableMaskHelper,s2efptoemh(value))
        SET_CASE(digitizer,EasyDPPFrontPanelTRGOUTEnableMaskHelper,s2edfptoemh(value))
        SET_CASE(digitizer,FrontPanelIOControl,s2ui(value))
        /* NOTE: generic and DPP share same structure and helpers here */
        SET_CASE(digitizer,EasyFrontPanelIOControl,s2efpioc(value))
        SET_CASE(digitizer,EasyDPPFrontPanelIOControl,s2efpioc(value))
        SET_CASE(digitizer,EasyFrontPanelIOControlHelper,s2efpioch(value))
        SET_CASE(digitizer,EasyDPPFrontPanelIOControlHelper,s2edfpioch(value))
        ...
        SET_CASE(digitizer,EasyFanSpeedControlHelper,s2efsch(value))
        SET_CASE(digitizer,EasyDPPFanSpeedControlHelper,s2edfsch(value))
        ...
        SET_CASE(digitizer,EasyReadoutControlHelper,s2erch(value))
        SET_CASE(digitizer,EasyDPPReadoutControlHelper,s2edrch(value))
...
static std::string get_(caen::Digitizer* digitizer, FunctionID functionID)
{
    switch(functionID)
    {
        ...
        GET_CASE(digitizer,EasyBoardConfigurationHelper,to_string)
        GET_CASE(digitizer,EasyDPPBoardConfigurationHelper,to_string)
        ...
        GET_CASE(digitizer,EasyAcquisitionControlHelper,to_string)
        GET_CASE(digitizer,EasyDPPAcquisitionControlHelper,to_string)
        ...
        GET_CASE(digitizer,EasyAcquisitionStatusHelper,to_string)
        GET_CASE(digitizer,EasyDPPAcquisitionStatusHelper,to_string)
        ...
        GET_CASE(digitizer,EasyGlobalTriggerMaskHelper,to_string)
        GET_CASE(digitizer,EasyDPPGlobalTriggerMaskHelper,to_string)
        ...
        GET_CASE(digitizer,EasyFrontPanelTRGOUTEnableMaskHelper,to_string)
        GET_CASE(digitizer,EasyDPPFrontPanelTRGOUTEnableMaskHelper,to_string)
        ...
        GET_CASE(digitizer,EasyFrontPanelIOControlHelper,to_string)
        GET_CASE(digitizer,EasyDPPFrontPanelIOControlHelper,to_string)
        ...
        GET_CASE(digitizer,EasyROCFPGAFirmwareRevisionHelper,to_string)
        GET_CASE(digitizer,EasyDPPROCFPGAFirmwareRevisionHelper,to_string)
        ...
        GET_CASE(digitizer,EasyFanSpeedControlHelper,to_string)
        GET_CASE(digitizer,EasyDPPFanSpeedControlHelper,to_string)
        ...
        GET_CASE(digitizer,EasyReadoutControlHelper,to_string)
        GET_CASE(digitizer,EasyDPPReadoutControlHelper,to_string)
        GET_CASE(digitizer,ReadoutStatus,to_string)
        GET_CASE(digitizer,EasyReadoutStatusHelper,to_string)
        GET_CASE(digitizer,EasyDPPReadoutStatusHelper,to_string)
...
static std::string get_(caen::Digitizer* digitizer, FunctionID functionID, int index)
{
    ...
    switch (functionID) {
        ...
        GET_ICASE(digitizer,EasyAMCFirmwareRevisionHelper,index,to_string)
        GET_ICASE(digitizer,EasyDPPAMCFirmwareRevisionHelper,index,to_string)
